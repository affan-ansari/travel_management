...
urlpatterns = [
    path('', views.browse_fixed_trips_home, name='agency-home'),
    ...
    path('invoices_paid', views.InvoiceView_paid, name='agency-invoice-list-paid'),
    path('invoices_unpaid', views.InvoiceView_unpaid, name='agency-invoice-list-unpaid'),
